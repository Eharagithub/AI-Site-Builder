    ...
    <>
      <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          ...
          <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Start for free and scale up you grow. Find the perfect plan for your content creation needs. </p>
        </div>
